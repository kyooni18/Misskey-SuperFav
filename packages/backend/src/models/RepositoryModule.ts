...
const $noteSuperFavoritesRepository: Provider = {
	provide: DI.noteSuperFavoritesRepository,
	useFactory: (db: DataSource) => db.getRepository(MiNoteSuperFavorite).extend(miRepository as MiRepository<MiNoteSuperFavorite>),
	inject: [DI.db],
};
