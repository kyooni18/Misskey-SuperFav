...
import { MiNoteSuperFavorite } from '@/models/NoteSuperFavorite.js';
...
export type NoteSuperFavoritesRepository = Repository<MiNoteSuperFavorite> & MiRepository<MiNoteSuperFavorite>;
